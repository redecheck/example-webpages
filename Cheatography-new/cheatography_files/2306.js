    ...
    var welcome_notification={"notification_title":"Welcome to Cheatography","notification_message":" Thanks for subscribing to push notifications","notification_url":"http:\/\/www.cheatography.com","welcome_enabled":"true"}; 
...
htmlbody1.insertAdjacentHTML( 'beforeend', '<iframe src="https://cheatography.pushengage.com/cookie.php" style="display: none;"></iframe>');
...
window.addEventListener('message',function(event) {
  if(event.origin !== 'https://cheatography.pushengage.com') return;
...
function attachDialogCss()
{
  ...
  var internalsegment=false;
      var _peapp={
  "app_key":"f61fcc23f400b8e38ba658636874538e",
  "app_id":"2306",
  "app_name":"Cheatography",
  "app_subdomain":"https://cheatography.pushengage.com",
  "app_image":"https://s3-us-west-2.amazonaws.com/assets.pushengage.com/site_images/2306495d01468411617.png",
  "app_poweredby":"powered by PushEngage",
  "app_url":"http://www.pushengage.com"
   };
   if(typeof(_pedata) == "undefined")
   var _pedata=[];
   var _pe_optin_settings={"desktop":{"optin_delay":1,"optin_type":1,"optin_title":"Cheatography would like to let you know about new cheat sheets!","optin_allow_btn_txt":"Go For It!","optin_close_btn_txt":"Not Now"},"mobile":{"optin_delay":1,"optin_title":"This website 'cheatography' would like to send you Push Notifications","optin_allow_btn_txt":"Allow","optin_close_btn_txt":"close"},"intermediate":null}; 
